...
Normally website developers don't need to bother with this, since WordPress core automatically redirects visitors to the canonical domain based on the `home` setting. Also any site with the [Seravo Plugin will automatically enforce](https://github.com/Seravo/seravo-plugin/blob/master/lib/canonical-domain-and-https.php) both the canonical domain and the use of HTTPS to ensure all visits are protected.
