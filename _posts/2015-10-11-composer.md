...
published: true
order: 1
summary: "WP-Palvelu uses **composer** by default for installing plugins and themes. You don't have to use it but it's there for you if you want to have better management of your dependencies."
---
