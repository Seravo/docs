...
Setting a cookie `seravo_shadow=1a2b3c;path=/` will return the staging instance to your browser.
...
https://mysite.seravo.com/?seravo_shadow=1ab2c3

The link above would set the cookie `seravo_shadow=1a2b3c;path=/` in your current browser session.
...
```
curl -iLs https://example.com/test.php?seravo_shadow=1a2b3c"
```
