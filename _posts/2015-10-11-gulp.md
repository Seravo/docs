...
## Default settings
Seravo template contains example `gulpfile.js`. Our example compiles sass files from `twentyfifteen` theme. It also has browsersync already configured for theme twentyfifteen so you can use it as base for your own projects.
